...
echo "and the files necessary to facilitate the app. If you are unsure of this app or"
echo "feel any amount of doubt about installing it - please cancel the installation."
echo "You can reach me directly for questions concerning any aspect from this app."
echo " "
echo "                          *************************"
echo " "
echo "              ***********************************************"
